...
const file_proto_helloworld_proto_rawDesc = "" +
	...
	"\bSayHello\x12\x18.helloworld.HelloRequest\x1a\x19.helloworld.HelloResponse\"\x00B\tZ\agen/apib\x06proto3"
...
var file_proto_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.GreetingService.SayHello:input_type -> helloworld.HelloRequest
	1, // 1: helloworld.GreetingService.SayHello:output_type -> helloworld.HelloResponse
